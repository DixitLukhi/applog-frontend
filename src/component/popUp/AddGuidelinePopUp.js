...
export default function AddGuidelinePopUp({ handleClose, data, setReload }) {
  ...
  const guidelineValidationSchema = Yup.object().shape({
    ...
    priority: Yup.string().required("priority info is required*"),
  });
              ...
              >
                <div className="grid grid-cols-1 gap-6 mt-4">
                  ...
                  <div className="card flex justify-content-center">
                    <Dropdown value={guidelineFormik.values.priority} onChange={(e) => {console.log(e.value); setguidelineInputValue("priority", e.value)}} options={priorities} optionLabel="name"
